...
//		stu3.aver=(double)(stu3.kor+stu3.eng)/(double)2;
		...
		//이런식으로 기능(메소드)를 잘 만들면.. 정말 편해짐
		
		//더 나아가.. 멤버값 일력하는것도 일일이 하나씩 대입하지말고
		//한번에 입력해주는 기능이 있다면.. 더 코드가 간결해 보일겁니다.!!
		
		Student stu5=new Student();
		//stu5.입력해("lee",70,50).. 이런식으로 입력기능을 사용하여 한번에 대입
		stu5.setMembers("lee",70,50);
		stu5.output();
