...
public class Main {
	...
	public static void main(String[] args) {
		...
		double sum2=cal.add(c, d); //메소드 오버로딩
		System.out.println("sum2: " + sum2);
		
		//이런식이면 문자열덧셈(결합)연산을 산술연산으로 하는 기능도 구현
		System.out.println("123"+"456");
		int sum3=cal.add("123", "456");
		System.out.println("sum3: " + sum3);
		
		//오버로딩을 사용한 가장 대표적인 기능(메소드) -- 화면출력기능 println()
		System.out.println();
		
		//가변길이 인자(파라미터) <-거의 안씀
		cal.total(3,6,7,5,8,9,10);
	}
